...
import {
  DeserializeArrayType,
  DeserializeComplexType,
  DeserializeDateType,
  DeserializeSimpleType,
} from "../main/DeserializationHelper";
...
describe("Testing Conversion functions", () => {
  it("Test DeserializeSimpleType case - String", () => {
    ...
    const moreFunctionsList = DeserializeSimpleType(
      instance,
      "field",
      "String",
      jsonTest,
  ...
  it("Test DeserializeSimpleType case - date", () => {
    ...
    const moreFunctionsList = DeserializeDateType(
      instance,
      "field",
      "Date",
      jsonTest,
  ...
  it("Test DeserializeArrayType - simple type array ", () => {
    ...
    const moreFunctionsList = DeserializeArrayType(
      testInstance,
      "field",
      String,
      json,
  ...
  it("Test DeserializeArrayType - undefined array ", () => {
    ...
    const moreFunctionsList1 = DeserializeArrayType(
      testInstance1,
      "field1",
      ComplexType,
      json,
    ...
    const moreFunctionsList2 = DeserializeArrayType(
      testInstance1,
      "field2",
      String,
      json,
    ...
    const moreFunctionsList3 = DeserializeArrayType(
      testInstance2,
      "field1",
      ComplexType,
      {},
    ...
    const moreFunctionsList4 = DeserializeArrayType(
      testInstance2,
      "field2",
      String,
      {},
  ...
  it("Test DeserializeComplexType - simple class ", () => {
    ...
    const moreFunctionsList = DeserializeComplexType(
      testInstance,
      undefined,
      DeserializeComplexTypeSimpleClassTest,
      json,
      undefined,
      { ignoreNameMetadata: true }
    );
  ...
  it("Test DeserializeComplexType - complex class ", () => {
    ...
    const moreFunctionsList = DeserializeComplexType(
      testInstance,
      undefined,
      DeserializeComplexTypeComplexClassTest,
      json,
      undefined,
      { ignoreNameMetadata: true }
    );
  ...
  it("Test DeserializeComplexType - complex array class ", () => {
    ...
    const json = {
      storeName: "PizzaHut",
      availableAt: [
        { zip: "2000", name: "Sydney" },
        { zip: "1871", name: "Liverpool" },
        { zip: "2600", name: "Canberra" },
      ],
    };
  ...
  it("Test DeserializeComplexType - simple array class ", () => {
    ...
    const moreFunctionsList = DeserializeComplexType(
      testInstance,
      undefined,
      DeserializeComplexTypeArrayTest1,
      json,
      undefined,
      { ignoreNameMetadata: true }
    );
  ...
  it("Test DeserializeComplexType - Date array class ", () => {
    ...
    const json = {
      dates: [
        new Date("04/02/2008").getTime(),
        new Date("05/2/2008").getTime(),
        new Date("04/02/2009").getTime(),
      ],
    };
    const testDateArrayInstance = new DeserializeComplexTypeDateArray();
    const moreFunctionsList = DeserializeComplexType(
      testDateArrayInstance,
      undefined,
      DeserializeComplexTypeDateArray,
      json,
      undefined,
      { ignoreNameMetadata: true }
    );
    expect(moreFunctionsList.length).toBe(0);
    expect(testDateArrayInstance.dates[0].getTime()).toBe(
      new Date("04/02/2008").getTime()
    );
  });
});
